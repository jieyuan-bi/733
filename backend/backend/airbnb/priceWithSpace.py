...
#1
    listings_input = spark.read.option("multiline", "true") \
        ...
        .option("escape", "\\") \
        .option("escape", '"') \
        .csv("listings_detailed\listings1.csv", schema=listings_schema, header=True)
    ...
    result.withColumnRenamed('neighbourhood_cleansed', 'neighbourhood') \
        .write.csv("analysis_results\priceWithSpace1", mode='overwrite', header=True)
...
#2
    listings_input = spark.read.option("multiline", "true") \
        ...
        .option("escape", "\\") \
        .option("escape", '"') \
        .csv("listings_detailed\listings2.csv", schema=listings_schema, header=True)
    ...
    result.withColumnRenamed('neighbourhood_cleansed', 'neighbourhood') \
        .write.csv("analysis_results\priceWithSpace2", mode='overwrite', header=True)
...
#3
    listings_input = spark.read.option("multiline", "true") \
        ...
        .option("escape", "\\") \
        .option("escape", '"') \
        .csv("listings_detailed\listings3.csv", schema=listings_schema, header=True)
    ...
    result.withColumnRenamed('neighbourhood_cleansed', 'neighbourhood') \
        .write.csv("analysis_results\priceWithSpace3", mode='overwrite', header=True)
...
#4
    listings_input = spark.read.option("multiline", "true") \
        ...
        .option("escape", "\\") \
        .option("escape", '"') \
        .csv("listings_detailed\listings4.csv", schema=listings_schema, header=True)
    ...
    result.withColumnRenamed('neighbourhood_cleansed', 'neighbourhood') \
        .write.csv("analysis_results\priceWithSpace4", mode='overwrite', header=True)
...
#5
    listings_input = spark.read.option("multiline", "true") \
        ...
        .option("escape", "\\") \
        .option("escape", '"') \
        .csv("listings_detailed\listings5.csv", schema=listings_schema, header=True)
    ...
    result.withColumnRenamed('neighbourhood_cleansed', 'neighbourhood') \
        .write.csv("analysis_results\priceWithSpace5", mode='overwrite', header=True)
...
#6
    listings_input = spark.read.option("multiline", "true") \
        ...
        .option("escape", "\\") \
        .option("escape", '"') \
        .csv("listings_detailed\listings6.csv", schema=listings_schema, header=True)
    ...
    result.withColumnRenamed('neighbourhood_cleansed', 'neighbourhood') \
        .write.csv("analysis_results\priceWithSpace6", mode='overwrite', header=True)
...
#7
    listings_input = spark.read.option("multiline", "true") \
        ...
        .option("escape", "\\") \
        .option("escape", '"') \
        .csv("listings_detailed\listings7.csv", schema=listings_schema, header=True)
    ...
    result.withColumnRenamed('neighbourhood_cleansed', 'neighbourhood') \
        .write.csv("analysis_results\priceWithSpace7", mode='overwrite', header=True)
