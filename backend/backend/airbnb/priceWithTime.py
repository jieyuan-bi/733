...
def main():
    ...
    listings_input=spark.read.option("multiline", "true") \
        ...
        .option("header", "true") \
        .option("escape", "\\") \
        .option("escape", '"').csv("Vancouver_all\\van_listings_detailed.csv",schema=listings_schema)
    '''
    ...
    calendar_input=spark.read.option("multiline", "true") \
        ...
        .option("header", "true") \
        .option("escape", "\\") \
        .option("escape", '"').csv("Vancouver_all\\van_calendar.csv",schema=calendar_schema)
    ...
    priceWithMonth.show()
    priceWithMonth.write.csv('analysis_results\priceWithMonth', mode='overwrite',header=True)
    ...
    priceWithWeek.write.csv("analysis_results\priceWithWeek", mode='overwrite',header=True)
